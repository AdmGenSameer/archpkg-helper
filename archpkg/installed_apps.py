...
def track_package(package_name: str, source: str, version: Optional[str] = None) -> None:
    """Convenience function to track a newly installed package"""
    package = InstalledPackage(
        name=package_name,
        source=source,
        version=version or "latest",
        install_date=datetime.now(timezone.utc).isoformat(),
        install_method="archpkg"
    )
