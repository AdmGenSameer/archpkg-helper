...
from archpkg.search.aur import search_aur, get_aur_package_details
...
class MainWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.setWindowTitle(f"ArchPkg - Cross-Platform Software Center ({self.detected_distro.title()})")
        ...
        header_title = QLabel("ArchPkg Software Center")
