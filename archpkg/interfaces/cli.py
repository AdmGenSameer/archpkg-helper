...
# Import modules
from archpkg.config.base import JUNK_KEYWORDS, LOW_PRIORITY_KEYWORDS, BOOST_KEYWORDS, DISTRO_MAP
from archpkg.core.exceptions import PackageManagerNotFound, NetworkError, TimeoutError, CommandGenerationError
from archpkg.search.aur import search_aur
from archpkg.search.pacman import search_pacman
from archpkg.search.flatpak import search_flatpak
from archpkg.search.snap import search_snap
from archpkg.search.apt import search_apt
from archpkg.search.dnf import search_dnf
from archpkg.search.zypper import search_zypper
from archpkg.search.rpm import search_rpm
from archpkg.package_management.command_gen import generate_command
from archpkg.config.logging import get_logger, PackageHelperLogger
from archpkg.integrations.github import install_from_github, validate_github_url
from archpkg.config.manager import get_user_config, set_config_option
from archpkg.config.manager import save_user_config
from archpkg.config.manager import UserConfig
from archpkg.package_management.update import check_for_updates, trigger_update_check
from archpkg.package_management.download import install_updates, start_background_update_service, stop_background_update_service
from archpkg.package_management.installed import add_installed_package, get_all_installed_packages, get_packages_with_updates
from archpkg.intelligence.suggest import suggest_apps, list_purposes
from archpkg.integrations.cache import get_cache_manager, CacheConfig
from archpkg.integrations.pkgs_org import PkgsOrgClient
from archpkg.package_management.snapshot import (
    create_snapshot, 
    list_snapshots, 
    restore_snapshot, 
    delete_snapshot,
...
from archpkg.intelligence.advisor import apply_user_mode_defaults, get_arch_news, assess_aur_trust
from archpkg.search.ranking import deduplicate_packages, get_top_matches, is_valid_package
...
def install_gui_dependencies() -> None:
    ...
    console.print(Panel(
        ...
        "This installs [cyan]PyQt5[/cyan] into the same Python environment that runs [cyan]archpkg[/cyan].",
        title="GUI Setup",
        border_style="cyan"
    ))
    ...
    try:
        ...
        console.print(Panel(
            ...
            "You can now run: [cyan]archpkg gui[/cyan]",
            title="GUI Ready",
            border_style="green"
        ))
    except Exception as e:
...
def gui(
    ...
    """
    try:
        from archpkg.interfaces.gui import launch_gui
        ...
        console.print("Run: archpkg add gui")
...
def add(
    ...
    """Install optional ArchPkg components such as the desktop GUI."""
    if debug:
        PackageHelperLogger.set_debug_mode(True)
