...
Usage:
    client = PkgsOrgClient(cache_dir="~/.cache/arjax", ttl=3600)
...
# Cache settings
DEFAULT_CACHE_DIR = os.path.expanduser("~/.cache/arjax")
...
class PkgsOrgClient:
    def __init__(
        ...
        ttl: int = 3600,
        user_agent: str = "arjax/1.0 (+https://github.com/AdmGenSameer/arjax)",
